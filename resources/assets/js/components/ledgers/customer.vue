                    ...
                    <Row :gutter="24">
                        ...
                        <Col span="24">
                            <FormItem  label="Opening Balance">
                                ...
                                v-model="formValue.opening"  ></Input>
                            </FormItem >
                        </Col>
                         <Col span="24">
...
<script>
    export default {
        ...
        methods: {
            ...
            async customerAdd(){
                this.loading=true
                let tempZone = this.formValue.zone
                this.formValue.zone=this.dataZone[tempZone].zoneName
                this.formValue.zoneId=this.dataZone[tempZone].id
                try{
            ...
            async edit(){
                this.sending=true
                let tempZone = this.editObj.zone
                this.editObj.zone=this.dataZone[tempZone].zoneName
                this.editObj.zoneId=this.dataZone[tempZone].id
                try{
                    let {data} =await  axios({
                        method: 'post',
